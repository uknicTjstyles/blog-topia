// "use client";
import RegistrationForm from '@/app/(auth)/sign-up/components/RegsiterForm';
...
const page = () => {
  return (
    <>
      ...
      <img src='https://res.cloudinary.com/dei2yklhq/image/upload/v1732043746/Group_1_jdvlql.png' className='w-[40rem] xl:w-[35vw] right-0 bottom-0 absolute ' alt="" />
